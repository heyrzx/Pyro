...
async def rename_start(client, message):
    ...
    try:
        await message.reply_text(
            text=f"ᴩʟᴇᴀꜱᴇ ᴇɴᴛᴇʀ ɴᴇᴡ ꜰɪʟᴇ ɴᴀᴍᴇ \n\nᴏʟᴅ ꜰɪʟᴇ ɴᴀᴍᴇ :- `{filename}`",
...
async def refunc(client, message):
    ...
    if (reply_message.reply_markup) and isinstance(reply_message.reply_markup, ForceReply):
        ...
        await message.reply(
            text=f"**ꜱᴇʟᴇᴄᴛ ᴛʜᴇ ᴏᴜᴛᴩᴜᴛ ꜰɪʟᴇ ᴛyᴩᴇ**\n**• ꜰɪʟᴇ ɴᴀᴍᴇ :-**```{new_name}```",
...
async def doc(bot, update):    
    ...
    ms = await update.message.edit("ᴛʀyɪɴɢ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ....")    
    try:
    ...
    if c_caption:
         try:
             ...
             return await ms.edit(text=f"yᴏᴜʀ ᴄᴀᴩᴛɪᴏɴ ᴇʀʀᴏʀ ᴇxᴄᴇᴩᴛ ᴋᴇyᴡᴏʀᴅ ᴀʀɢᴜᴍᴇɴᴛ ●> ({e})")             
    else:
    ...
    await ms.edit("ᴛʀyɪɴɢ ᴛᴏ ᴜᴩʟᴏᴀᴅɪɴɢ....")
    ...
    try:
        if type == "document":
            await bot.send_document(
                ...
                progress_args=("ᴜᴩʟᴏᴅ ꜱᴛᴀʀᴛᴇᴅ....", ms, time.time()))
        elif type == "video": 
